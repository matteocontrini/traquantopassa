...
import ftmStationsList from '$lib/server/ftm/ftm-stations-list';
...
`;
	...
	for (const station of ftmStationsList) {
		xml += `	<url><loc>${BASE_URL}/ftm/${station.slug}</loc></url>
`;
	}
